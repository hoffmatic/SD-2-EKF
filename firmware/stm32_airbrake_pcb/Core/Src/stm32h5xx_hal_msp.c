...
/* USER CODE BEGIN 0 */
/*
 * MSP wiring notes for the Airbrake PCB:
 *   - I2C1 -> LSM6DSV32X IMU.
 *   - I2C2 -> BMP388 barometer.
 *   - I2C3 -> LIS2MDL magnetometer.
 *   - SPI1 -> SX1280 radio.
 *   - SPI2 -> TMC5240 motor driver.
 *   - SPI3 -> external flash.
 *
 * The handwritten drivers assume these bus assignments.  If CubeMX changes a
 * pin or peripheral instance, update the corresponding driver comments and
 * board handles in rocket_sensors.c / radio / motor modules.
 */
